        ...
        <?php foreach($allListings as $allListing) : ?>
          <div class="col-md-6 col-lg-4 mb-4">
            <div class="property-entry h-100">
              <a href="<?php echo APPURL; ?>property-details.php?id=<?php echo $allListing->id; ?>" class="property-thumbnail">
              ...
              <div class="p-4 property-body">
                <h2 class="property-title"><a href="property-details.html"><?php echo $allListing->name; ?></a></h2>
